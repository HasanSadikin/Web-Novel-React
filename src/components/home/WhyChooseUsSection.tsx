  ...
  const data = [
    {
      ...
      description:
        "Unlock your storytelling potential with our user-friendly platform. Craft and share your masterpiece effortlessly!",
    },
    {
      logo: (
        <svg
      ...
      description:
        "Join a vibrant community of novel enthusiasts. Engage in discussions, receive feedback, and connect with fellow creators and avid readers",
    },
    {
      logo: (
        <svg
      ...
      description:
        "Join a vibrant community of novel enthusiasts. Engage, receive feedback, and connect with creators and readers",
    },
  ];
  return (
    <div className="w-full py-10 h-fit poppins">
      <h1 className="pb-8 text-3xl font-semibold text-center lg:text-5xl lg:py-16">
        Why Us
      </h1>
      <div className="grid w-10/12 grid-cols-1 gap-2 mx-auto h-fit xl:gap-10 lg:w-3/4 lg:grid-cols-3">
        {data.map((x) => (
          <div className="flex flex-col gap-5 p-10 rounded-lg shadow-md bg-base-200 h-96">
            <div className="flex justify-center">{x.logo}</div>
            <div className="lg:min-h-16">
              <h1 className="text-2xl font-semibold text-center lg:text-left">
                {x.title}
              </h1>
            </div>
            <p className="text-sm text-center lg:text-md lg:text-left">
              {x.description}
            </p>
          </div>
        ))}
